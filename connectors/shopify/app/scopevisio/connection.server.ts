...
import { DEFAULT_BASE_URL , encrypt } from "@erp/scopevisio-core";
import { ScopevisioClient, ScopevisioError, type ConnectionInput } from "@erp/scopevisio-core";
...
export async function testCredentials(shop: string, input: ConnectionInput) {
  const client = ScopevisioClient.ephemeral(input);
